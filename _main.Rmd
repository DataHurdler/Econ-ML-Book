...
```{python 'epsilon greedy', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[1:130]}
```
...
```{python 'eg-global parameters', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[8:12]}
```
...
```{python 'class BayesianAB', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[15:69]}
```
...
```{python 'win rates', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[66:69]}
```
...
```{python 'def pull/update', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[71:105]}
```
...
```{python 'def epsilon_greedy', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[107:130]}
```
...
```{python 'call epsilon_greedy()', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[369:373]}
```
...
```{python 'def plot_history', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[295:331]}
```

Then execute:

```{python 'eg plot_history', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[404]}
```
...
```{python 'eg plot_history 100', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[407]}
```
...
```{python 'def optim_init_val', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[132:153]}
```
...
```{python 'call optim_init_val()', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[384:394]}
```
...
```{python 'def ucb1', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[155:181]}
```
...
```{python 'call ucb1()', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[397:407]}
```
...
```{python 'def gb_update/gradient_bandit', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[183:236]}
```
...
```{python 'plot_history accomodates gb', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[314:317]}
```
...
```{python 'run gradient_bandit()', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[410:420]}
```
...
```{python 'plot gb preference', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[423]}
```
...
```{python 'plot gb pi', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[426]}
```
...
```{python 'def bb_update/bayesian_bandits', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[238:292]}
```
...
```{python 'def bb_plot_history', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[334:362]}
```

We can now run a simulate for `Thompson Sampling` by executing the following:

```{python 'run bb_plot_history()', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py")[429:439]}
```
...
```{python 'bayesianab.py', class.source = 'fold-hide', eval=F, file="https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab.py"}
```
...
```{python 'bayesianab_mc.py', eval=F, file="https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab_mc.py"}
```
...
```{python 'algorithm list', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab_mc.py")[174]}
```
...
```{python 'probability list', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Multi-Armed-Bandits/bayesianab_mc.py")[175:179]}
```
...
```{python 'tree_ensembles.py', eval=F, file="https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Tree-Ensembles/tree_ensembles.py"}
```
...
```{python 'add random noise', eval=F, code = readLines("https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Tree-Ensembles/tree_ensembles.py")[71:74]}
```
...
```{python tree_ensembles_mc.py, eval=F, file="https://raw.githubusercontent.com/DataHurdler/Econ-ML/main/Tree-Ensembles/tree_ensembles_mc.py"}
```
